/*
programa para preencher um vetor de 10 posições com valores inteiros aleatorios.
Em seguida imprimir:
...
public class Exemplo1 {
    public static void main(String[] args) {
        ...
        System.out.println("media dos elementos ---> " + calcularMedia(vetor));
